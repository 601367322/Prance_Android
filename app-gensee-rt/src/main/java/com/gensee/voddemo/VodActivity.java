...
public class VodActivity extends Activity implements OnClickListener,
	...
	private String[] mServiceTypes = { ServiceType.WEBCAST.getValue(),
...
//				notifyData();
	...
	public void initView() {
		...
		mEditK = (EditText) findViewById(R.id.editK);
	...
	public void onClick(View currenView) {
		if (currenView.getId() == R.id.mbutton) {
			...
			String k = mEditK.getText().toString();
...
//			initParam.setLiveId("4afd6bd6fdfc4e17b3ca2273d7182039");
			// 站点认证帐号
